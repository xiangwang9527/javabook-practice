...
api[0].list.push({
    alias: 'fc39125a12d0e664fe4145b0654aaeb5',
    order: '1',
    link: '并发压力测试controller',
    desc: '并发压力测试Controller',
    list: []
})
api[0].list[0].list.push({
    order: '1',
    deprecated: 'false',
    url: 'http://127.0.0.1:8080/idempotent/token',
    desc: '先通过接口得到token',
});
api[0].list[0].list.push({
    order: '2',
    deprecated: 'false',
    url: 'http://127.0.0.1:8080/idempotent/again',
    desc: '再测试幂等',
});
api[0].list[0].list.push({
    order: '3',
    deprecated: 'false',
    url: 'http://127.0.0.1:8080/idempotent/user',
    desc: '用户查询',
});
